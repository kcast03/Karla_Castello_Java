...
public class ChatterbookController {
    ...
    //GET route for list of all users
    ...
    //GET route for list of all chatterposts for a user by username
    @RequestMapping(value = "/users/chatterposts/{username}", method = RequestMethod.GET)
    @ResponseStatus(value = HttpStatus.OK)
    public List<ChatterPost> getListOfChatterpostsByName(@PathVariable String username){
